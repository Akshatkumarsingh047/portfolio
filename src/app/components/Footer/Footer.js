            ...
            <div className="flex flex-wrap items-center justify-between">
              <div className="w-1/3 mb-10 sm:w-auto sm:mx-4 sm:mb-0">
                <a
                  ...
                  target="_blank"
                  href="https://github.com/Akshatkumarsingh047"
                >
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
              ...
              <div className="w-1/3 mb-10 sm:w-auto sm:mx-4 sm:mb-0">
                <a
                  className="flex flex-col items-center justify-center group"
                  target="_blank"
                  href="https://www.linkedin.com/in/akshat-singh-687107231/"
                >
                  {" "}
                  <svg
                    stroke="currentColor"
              ...
              <div className="w-1/3 mb-10 -ml-5 sm:w-auto sm:mx-4 sm:mb-0">
                <a
                  className="flex flex-col items-center justify-center group"
                  target="_blank"
                 href="mailto:akshatkumarsingh047@gmail.com"
                >
                 <svg
                    stroke="currentColor"
                    fill="currentColor"
